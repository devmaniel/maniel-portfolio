    ...
    <>
      ...
      >
        <div className="relative" onClick={(e) => e.stopPropagation()}>
          ...
          {/* Modal Content */}
          <div className="w-[300px] h-[600px]  md:w-[700px] md:h-[750px] lg:w-[1100px] lg:h-[900px] max-w-[calc(100vw-40px)] max-h-[calc(100vh-80px)] overflow-hidden overflow-y-auto mt-5 bg-white p-5 flex flex-col gap-5 rounded-l">
